...
@WebServlet("/DisplayUserBorrow")
public class DisplayUserBorrow extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		if(checkAuthentication(cookies,false))
		{
			...
			Criteria user_criteria = new Criteria(Column.getColumn("User","USER_LOGIN_ID"), user_login_id, QueryConstants.EQUAL);

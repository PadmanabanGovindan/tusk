...
@WebServlet("/DisplayTotalMarks")
public class DisplayTotalMarks extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Join  joinClass = new Join("Student_Details", "Class", new String [] {"CLASS_ID"}, new String [] {"CLASS_ID"}, Join.LEFT_JOIN);
		...
		GroupByColumn gbc3 = new GroupByColumn(new Column("Marks","STUDENT_ID"),true);
		GroupByColumn gbc4 = new GroupByColumn(new Column("Class","CLASS_NAME"),true);
		GroupByColumn gbc5 = new GroupByColumn(new Column("Class","CLASS_ID"),true);
		...
		try {
			...
			while (ds.next())
		    {
				...
				record.put("Total_Mark", ds.getValue("TOTAL_MARKS"));
				sq.put(record);
		    }

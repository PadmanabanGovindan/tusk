...
@WebServlet("/DisplayStudentsbyMarks")
public class DisplayStudentsbyMarks extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Column sbc1 = new Column("Marks","MARK");
		SortColumn sbc = new SortColumn(sbc1,false);

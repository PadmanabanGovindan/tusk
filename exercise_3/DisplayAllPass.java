...
@WebServlet("/DisplayAllPass")
public class DisplayAllPass extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		query.setCriteria(new Criteria(Column.getColumn("Marks","MARK"), 50, QueryConstants.GREATER_THAN));
		...
		GroupByClause gbcl = new GroupByClause(list, new Criteria(c1,4,QueryConstants.EQUAL));
